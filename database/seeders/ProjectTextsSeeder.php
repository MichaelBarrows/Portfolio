    ...
    public function run()
    {
        DB::table('project_texts')->insert([
            ...
            [
                ...
                'format' => 'p',
                'order' => 2,
                'text' => "A website for calculating university grades (module, year, undergraduate degree, integrated master's degree, and master's degree).",
            ],
            [
                'project_id' => 4,
                'format' => 'h3',
            ...
            [
                ...
                'format' => 'p',
                'order' => 8,
                'text' => "Version 2 was created in 2020 and uses much of the same code as version 1. Version 2 was developed using Laravel to allow for future expansion.",
            ],
            [
                'project_id' => 4,
                'format' => 'p',
                'order' => 9,
                'text' => "Changes in version 2 included: calculators for degree grades (undergraduate, master's and integrated master's), a better user interface and prefilled values (can be modified) for the credits with the degree calculators.",
            ],
            [
                'project_id' => 4,
                'format' => 'h3',
            ...
            [
                ...
                'format' => 'p',
                'order' => 11,
                'text' => "Future development of the website will hopefully allow users to store their grades so that they don't have to re-enter them every time.",
            ],
            [
                'project_id' => 4,
                'format' => 'p',
